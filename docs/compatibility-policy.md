...
This document defines compatibility expectations for versioned artifacts across every `traverse-framework` repo. Repo-specific compatibility statements (e.g. a particular release's public-surface guarantees) live in that repo's own docs and should link back here for the general rules, rather than restating them.

## Governed Versioned Surfaces

The following surfaces are versioned and compatibility-sensitive, wherever they exist in a given repo:
...
## Runtime, Registry, and MCP Surfaces
