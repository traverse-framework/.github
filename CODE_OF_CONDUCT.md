...
`traverse-framework` organization, and also applies when an individual is
officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be
reported to the project owner at **enrico.piovesan10@gmail.com**. All
...
2. **Warning** — a warning with consequences for continued behavior, including
   a period of no unsolicited interaction with those involved.
